...
public class Ex01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("A idade de " + cachorro1.getNome() + " È: " 
		+ cachorro1.getIdade());
		...
		System.out.println("Idade de " + cavalo1.getNome() + " È: " 
		+ cavalo1.getIdade());
		cavalo1.cavaloCorre();
		...
		System.out.println("Nome da pregui√ßa: " + preguica1.getNome());
		System.out.println("idade de " + preguica1.getNome() + " È: "
		+ preguica1.getIdade());
